import{m as n}from"./maquinas-gTVh8Vsc.js";const o=localStorage.getItem("activeUser")?localStorage.getItem("activeUser"):window.location.href="../index.html",e=JSON.parse(o),a=n.getAll().map(t=>t.name===e.maquina&&{...e,...t}).find(t=>t);document.body.innerHTML+=`
